...
public class InfusionRecipes {
    public static void initializeInfusionRecipes() {
        ...
        if(ModConfig.ISTHAUMICADDITIONS){
            ...
            //Issue is with ItemsTAR, it only causes crash with it present, otherwise doesnt -> does not work with "" because oredict
            //Arcane has same problem
            ...
            RecipeApi.changeInfusionRecipe(new ResourceLocation( "thaumadditions","adaminite_ingot"), new AspectList().add(Aspect.LIFE, 50).add(Aspect.ALCHEMY, 30).add(Aspect.EXCHANGE, 40).add(Aspect.METAL, 40).add(Aspect.SOUL, 60).add(Aspect.MAGIC, 50).add(org.zeith.thaumicadditions.init.KnowledgeTAR.DRACO, 10), new Object[]{ new ItemStack(Items.END_CRYSTAL), new ItemStack(ItemsTC.fabric), primordialPearl});
            RecipeApi.changeInfusionRecipe(new ResourceLocation( "thaumadditions","mithminite_ingot"),new AspectList().add(org.zeith.thaumicadditions.init.KnowledgeTAR.CAELES, 10).add(Aspect.METAL, 60).add(Aspect.LIFE, 90).add(Aspect.MAGIC, 60), new Object[]{new ItemStack(org.zeith.thaumicadditions.init.ItemsTAR.MITHRILLIUM_INGOT), new ItemStack(ItemsTC.quicksilver), new ItemStack(org.zeith.thaumicadditions.init.ItemsTAR.MITHRILLIUM_INGOT), new ItemStack(ItemsTC.quicksilver)});

            RecipeApi.changeInfusionRecipe(new ResourceLocation( "thaumadditions","mithrillium_resonator"), org.zeith.thaumicadditions.api.AspectUtil.primals(10).add(org.zeith.thaumicadditions.init.KnowledgeTAR.IMPERIUM, 10),new Object[]{ new ItemStack(org.zeith.thaumicadditions.init.ItemsTAR.MITHRILLIUM_PLATE), new ItemStack(ItemsTC.mechanismComplex)});

            RecipeApi.changeInfusionRecipe(new ResourceLocation( "thaumadditions","adaminite_sword"), new AspectList().add(org.zeith.thaumicadditions.init.KnowledgeTAR.DRACO, 20).add(Aspect.MAGIC, 70).add(Aspect.AVERSION, 150).add(org.zeith.thaumicadditions.init.KnowledgeTAR.INFERNUM, 90).add(Aspect.METAL, 60),new Object[]{ "plateAdaminite", "plateAdaminite", primordialPearl, "plateAdaminite"});

            RecipeApi.changeInfusionRecipe(new ResourceLocation( "thaumadditions","mithminite_scythe"), new AspectList().add(Aspect.AVERSION, 250).add(Aspect.TOOL, 150).add(Aspect.MAGIC, 100),new Object[]{ new ItemStack(org.zeith.thaumicadditions.init.ItemsTAR.MITHMINITE_BLADE), new ItemStack(org.zeith.thaumicadditions.init.ItemsTAR.MITHMINITE_PLATE), new ItemStack(org.zeith.thaumicadditions.init.ItemsTAR.MITHMINITE_HANDLE)});
            RecipeApi.changeInfusionRecipe(new ResourceLocation( "thaumadditions","mithminite_blade"), new AspectList().add(Aspect.AVERSION, 150).add(org.zeith.thaumicadditions.init.KnowledgeTAR.INFERNUM, 50),new Object[]{ new ItemStack(org.zeith.thaumicadditions.init.ItemsTAR.MITHMINITE_PLATE), new ItemStack(org.zeith.thaumicadditions.init.ItemsTAR.MITHMINITE_PLATE), new ItemStack(org.zeith.thaumicadditions.init.ItemsTAR.MITHRILLIUM_RESONATOR)});
            RecipeApi.changeInfusionRecipe(new ResourceLocation( "thaumadditions","mithminite_handle"), new AspectList().add(Aspect.TOOL, 100).add(Aspect.SOUL, 75),new Object[]{ new ItemStack(org.zeith.thaumicadditions.init.ItemsTAR.MITHMINITE_PLATE), new ItemStack(org.zeith.thaumicadditions.init.ItemsTAR.MITHMINITE_INGOT)});

            RecipeApi.changeInfusionRecipe(new ResourceLocation( "thaumadditions","aura_disperser"), new AspectList().add(org.zeith.thaumicadditions.init.KnowledgeTAR.FLUCTUS, 30).add(Aspect.AURA, 10).add(Aspect.ALCHEMY, 20).add(org.zeith.thaumicadditions.init.KnowledgeTAR.VENTUS, 50),new Object[]{ new ItemStack(ItemsTC.mechanismComplex), org.zeith.thaumicadditions.api.AspectUtil.salt(Aspect.AURA), org.zeith.thaumicadditions.api.AspectUtil.salt(Aspect.ALCHEMY), new ItemStack(BlocksTC.shimmerleaf), new ItemStack(ItemsTC.morphicResonator), org.zeith.thaumicadditions.api.AspectUtil.salt(org.zeith.thaumicadditions.init.KnowledgeTAR.FLUCTUS), "nitor"});

            RecipeApi.changeInfusionRecipe(new ResourceLocation( "thaumadditions","crystal_crusher"), new AspectList().add(Aspect.CRAFT, 20).add(org.zeith.thaumicadditions.init.KnowledgeTAR.EXITIUM, 20).add(Aspect.TOOL, 20),new Object[]{ org.zeith.thaumicadditions.api.AspectUtil.crystalEssence(Aspect.AIR), org.zeith.thaumicadditions.api.AspectUtil.crystalEssence(Aspect.EARTH), org.zeith.thaumicadditions.api.AspectUtil.crystalEssence(Aspect.FIRE), org.zeith.thaumicadditions.api.AspectUtil.crystalEssence(Aspect.WATER), org.zeith.thaumicadditions.api.AspectUtil.crystalEssence(Aspect.ORDER), org.zeith.thaumicadditions.api.AspectUtil.crystalEssence(Aspect.ENTROPY), new ItemStack(ItemsTC.plate, 1, 2), new ItemStack(ItemsTC.plate, 1, 2), new ItemStack(ItemsTC.plate, 1, 2), new ItemStack(BlocksTC.slabArcaneStone), new ItemStack(org.zeith.thaumicadditions.init.ItemsTAR.SALT_ESSENCE)});

            RecipeApi.changeInfusionRecipe(new ResourceLocation( "thaumadditions","enchanted_golden_apple"), new AspectList().add(Aspect.DESIRE, 10).add(Aspect.LIFE, 5).add(org.zeith.thaumicadditions.init.KnowledgeTAR.VISUM, 20),new Object[]{ new ItemStack(Blocks.GOLD_BLOCK), new ItemStack(Blocks.GOLD_BLOCK), new ItemStack(Blocks.GOLD_BLOCK), new ItemStack(Blocks.GOLD_BLOCK), new ItemStack(Blocks.GOLD_BLOCK), new ItemStack(Blocks.GOLD_BLOCK), new ItemStack(Blocks.GOLD_BLOCK), new ItemStack(Blocks.GOLD_BLOCK)});

            RecipeApi.changeInfusionRecipe(new ResourceLocation( "thaumadditions","growth_chamber"), new AspectList().add(Aspect.ORDER, 20).add(Aspect.MECHANISM, 15).add(org.zeith.thaumicadditions.init.KnowledgeTAR.IMPERIUM, 10),new Object[]{ ItemsTC.amber, new ItemStack(ItemsTC.plate, 1, 2), ItemsTC.morphicResonator, new ItemStack(ItemsTC.plate, 1, 2), ItemsTC.visResonator, new ItemStack(ItemsTC.plate, 1, 2), ItemsTC.mechanismSimple, new ItemStack(ItemsTC.plate, 1, 2)});
            RecipeApi.changeInfusionRecipe(new ResourceLocation( "thaumadditions","chester"), new AspectList().add(org.zeith.thaumicadditions.init.KnowledgeTAR.IMPERIUM, 80).add(Aspect.LIFE, 40).add(Aspect.VOID, 20).add(Aspect.MECHANISM, 10),new Object[]{ new ItemStack(BlocksTC.plankGreatwood), "ingotThaumium", new ItemStack(BlocksTC.plankGreatwood), new ItemStack(ItemsTC.brain), new ItemStack(BlocksTC.plankGreatwood), new ItemStack(ItemsTC.morphicResonator), "ingotThaumium"});

            RecipeApi.changeInfusionRecipe(new ResourceLocation( "thaumadditions","wormhole_mirror"), new AspectList().add(Aspect.ELDRITCH, 50).add(org.zeith.thaumicadditions.init.KnowledgeTAR.IMPERIUM, 50).add(org.zeith.thaumicadditions.init.KnowledgeTAR.VISUM, 40), new Object[]{new ItemStack(org.zeith.thaumicadditions.init.ItemsTAR.VOID_THAUMOMETER), new ItemStack(ItemsTC.plate, 1, 3), new ItemStack(ItemsTC.plate, 1, 3)});
            ...
            RecipeApi.changeInfusionRecipe(new ResourceLocation( "thaumadditions","void_crop"), org.zeith.thaumicadditions.api.AspectUtil.primals(20).add(Aspect.DARKNESS, 50).add(org.zeith.thaumicadditions.init.KnowledgeTAR.CAELES, 5), new Object[]{primordialPearl, new ItemStack(ItemsTC.voidSeed), new ItemStack(ItemsTC.salisMundus)});
            RecipeApi.changeInfusionRecipe(new ResourceLocation( "thaumadditions","shadow_enchanter"), org.zeith.thaumicadditions.api.AspectUtil.primals(100).add(Aspect.MIND, 300), new Object[]{new ItemStack(org.zeith.thaumicadditions.init.ItemsTAR.MITHRILLIUM_PLATE), "ingotThaumium", new ItemStack(org.zeith.thaumicadditions.init.ItemsTAR.MITHRILLIUM_RESONATOR), new ItemStack(ItemsTC.mechanismComplex), new ItemStack(org.zeith.thaumicadditions.init.ItemsTAR.MITHRILLIUM_PLATE), "ingotThaumium", new ItemStack(org.zeith.thaumicadditions.init.ItemsTAR.DISENCHANT_FABRIC)});
            RecipeApi.changeInfusionRecipe(new ResourceLocation( "thaumadditions","shadow_beam_staff"), org.zeith.thaumicadditions.api.AspectUtil.primals(50).add(Aspect.ELDRITCH, 200).add(org.zeith.thaumicadditions.init.KnowledgeTAR.DRACO, 50), new Object[]{new ItemStack(org.zeith.thaumicadditions.init.ItemsTAR.MITHRILLIUM_PLATE), "plateIron", new ItemStack(org.zeith.thaumicadditions.init.ItemsTAR.MITHRILLIUM_PLATE), "plateIron", new ItemStack(org.zeith.thaumicadditions.init.ItemsTAR.MITHRILLIUM_PLATE), "plateIron"});
            RecipeApi.changeInfusionRecipe(new ResourceLocation( "thaumadditions","void_anvil"), new AspectList().add(Aspect.ELDRITCH, 100).add(org.zeith.thaumicadditions.init.KnowledgeTAR.CAELES, 10), new Object[]{new ItemStack(ItemsTC.plate, 1, 3), new ItemStack(ItemsTC.plate, 1, 3), new ItemStack(BlocksTC.metalBlockVoid), new ItemStack(ItemsTC.plate, 1, 3), new ItemStack(ItemsTC.plate, 1, 3),new ItemStack(ItemsTC.plate, 1, 3), new ItemStack(ItemsTC.plate, 1, 3), new ItemStack(ItemsTC.plate, 1, 3), new ItemStack(ItemsTC.plate, 1, 3), new ItemStack(ItemsTC.plate, 1, 3), new ItemStack(ItemsTC.plate, 1, 3), new ItemStack(BlocksTC.metalBlockVoid)});
            RecipeApi.changeInfusionRecipe(new ResourceLocation( "thaumadditions","the_beheader"), new AspectList().add(Aspect.UNDEAD, 100).add(Aspect.ENTROPY, 70).add(Aspect.MAGIC, 85).add(Aspect.AVERSION, 120).add(Aspect.DEATH, 70), new Object[]{new ItemStack(org.zeith.thaumicadditions.init.ItemsTAR.MITHRILLIUM_PLATE), new ItemStack(Items.SKULL, 1, 1), new ItemStack(org.zeith.thaumicadditions.init.ItemsTAR.MITHRILLIUM_PLATE), new ItemStack(ItemsTC.plate, 1, 2), new ItemStack(org.zeith.thaumicadditions.init.ItemsTAR.MITHRILLIUM_PLATE)});
